...
import { 
  ...
  FaChartBar, FaPalette, FaDatabase, FaTools, FaBullseye,
  FaGem, FaThumbsUp, FaUserShield, FaInfinity, FaShoppingCart,
  FaHospital, FaUniversity, FaHome, FaIndustry, FaGamepad,
  FaCar, FaPlane, FaUtensils, FaTshirt
} from "react-icons/fa";
import { 
  HiSparkles, HiLightningBolt, HiTrendingUp, HiBadgeCheck,
  HiChartBar, HiCog, HiDesktopComputer, HiDatabase, HiCube,
  HiShoppingBag, HiAcademicCap
} from "react-icons/hi";
...
// Enhanced Industries We Serve - Modern Cards
const industries = [
  { 
  ...
  return (
    <div className="page-container overflow-x-hidden">
      ...
      <main className="flex-1">
                    ...
                    {hoveredIndustry === index && (
                      <div className="absolute inset-0 pointer-events-none">
                        {[...Array(8)].map((_, i) => (
                          <motion.div
                            key={i}
                            className={`absolute w-1 h-1 rounded-full bg-gradient-to-r ${industry.color}`}
                            initial={{
                              x: Math.random() * 200,
                              y: Math.random() * 300,
                              opacity: 0
        ...
        {/* Final CTA Section */}
        <section className="py-24 bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white relative overflow-hidden mb-0">
