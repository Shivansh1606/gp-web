...
import { 
  FaMobileAlt, FaCloud, FaGlobe, FaRocket, FaShieldAlt, FaCode,
  FaPalette, FaDatabase, FaArrowRight, FaCheck, FaStar, FaPlay,
  FaUsers, FaClock, FaTags, FaLightbulb, FaChartBar
} from "react-icons/fa";
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <motion.a
                  href="#services"
                  className="group inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl font-semibold hover:shadow-2xl transition-all duration-300"
                      ...
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-4">
                          <div className="flex items-center gap-1 text-gray-600">
                            <FaTags size={12} />
                            <span className="text-lg font-bold text-gray-800">Starting {service.price}</span>
                          </div>
                        </div>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {processSteps.map((step, index) => (
                ...
                >
                  <div className="bg-white rounded-3xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-blue-500">
